...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'dende_todo.factory.task' => 'getDendeTodo_Factory_TaskService',
            'dende_todo.factory.todo_list' => 'getDendeTodo_Factory_TodoListService',
    ...
    /**
     * Gets the 'dende_todo.factory.task' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dende\Application\Factory\TaskFactory A Dende\Application\Factory\TaskFactory instance.
     */
    protected function getDendeTodo_Factory_TaskService()
    {
        return $this->services['dende_todo.factory.task'] = new \Dende\Application\Factory\TaskFactory();
    }

    /**
     * Gets the 'dende_todo.factory.todo_list' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Dende\Application\Factory\TodoListFactory A Dende\Application\Factory\TodoListFactory instance.
     */
    protected function getDendeTodo_Factory_TodoListService()
    {
        return $this->services['dende_todo.factory.todo_list'] = new \Dende\Application\Factory\TodoListFactory();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'test_phing', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/Dende/Bundle/AppBundle/Resources/config/doctrine') => 'Dende\\Domain'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Dende\\Domain');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('App' => 'Dende\\Domain'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_43681c71b5c54699adb730bcc9516153653098502a51ff01e2d36b0db868ce48');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Dende/Bundle/AppBundle/Resources/views'), 'TodoApp');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c817049b30b3a6ea53fee7aecec05f3501085949');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5698d87f9859a1.63661750')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TodoAppBundle' => 'Dende\\Bundle\\AppBundle\\TodoAppBundle',
                'VMCommonBundle' => 'VM\\CommonBundle\\VMCommonBundle',
            ...
            'secret' => 'c817049b30b3a6ea53fee7aecec05f3501085949',
            'locale' => 'en',
            ...
            'kernel.secret' => 'c817049b30b3a6ea53fee7aecec05f3501085949',
